<div class="me-3">
  <a href="#back-to-top" title="Top page"><i class="bi bi-arrow-up-square-fill h1 float-end text-success"></i></a>
</div>
<footer class="bg-dark text-center text-white mt-auto">
  ...
  <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
    <?php echo date('Y'); ?> - Tous droits reservés - Site factice - Aurore Desmis
    <a href="../View/mentions_legales.php"> - Mentions légales</a>
    <a href="../View/cgv.php"> - Conditions générales de vente</a>
  </div>
  <!-- Copyright -->
